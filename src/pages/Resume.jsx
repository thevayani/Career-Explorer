...
import image from '../assets/red.webp';
        ...
        <Container>
            <Row>
                <Col sm="6">
                    ...
                    <ul>
                        {inputValue.languageknown?.map((v, index) => (
                            <li key={index} style={{ width: "400px", marginLeft: "100px", color: "white" }}>
                                <i>{v}</i>
                                <Button
                                    variant="danger"
                                    size="sm"
                    ...
                    <Row className="mb-3" style={{ marginLeft: "85px" }}>
                        <Col sm="6">
                            <h4 style={{ color: "white" }}><i>Skills</i></h4>
                            <Form.Control
                                style={{ width: "100%" }}
                                type="text"
                                value={skillValue}
                    ...
                    <ul>
                        {inputValue.skills?.map((v, index) => (
                            <li key={index} style={{ width: "400px", marginLeft: "100px", color: "white" }}>
                                <i>{v}</i>
                                <Button variant="danger" onClick={() => deleteskill(v)} style={{ marginLeft: "10px" }}>x</Button>
                            </li>
                        ))}
                    </ul>
                    ...
                    <ul>
                        {inputValue.hobbies?.map((v, index) => (
                            <li key={index} style={{ width: "400px", marginLeft: "100px", color: "white" }}>
                                <i>{v}</i>
                                <Button
                                    variant="danger"
